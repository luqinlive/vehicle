                ...
                {  
                    ...
                    {  
                        ...
                        case "System.Drawing.Image":
                            ...
                            {
                                ((System.Drawing.Image)row[column]).Save(ms, System.Drawing.Imaging.ImageFormat.Jpeg);
                                int pictureIndex = workbook.AddPicture(ms.ToArray(), PictureType.JPEG);
                                ICreationHelper helper = workbook.GetCreationHelper();
                                IDrawing drawing = sheet.CreateDrawingPatriarch();
                                //IClientAnchor anchor = helper.CreateClientAnchor();
                                //anchor.Col1 = newCell.ColumnIndex;//0 index based column
                                //anchor.Row1 = newCell.RowIndex;//0 index based row
                                HSSFClientAnchor anchor = new HSSFClientAnchor(0, 0, 100, 50, newCell.ColumnIndex, newCell.RowIndex, newCell.ColumnIndex + 1, newCell.RowIndex + 1);
