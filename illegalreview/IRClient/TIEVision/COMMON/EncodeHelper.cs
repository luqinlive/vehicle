...
namespace TIEVison.COMMON
{
    ...
    public sealed class EncodeHelper
    {
        ...
        public const string DEFAULT_ENCRYPT_KEY = "myferret";
        static public byte[] IV = { 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF };
        ...
        public static string DesEncrypt(string strText)
        {
            try
            {
                string string64 = DesEncrypt(strText, DEFAULT_ENCRYPT_KEY);
        ...
        public static string DesDecrypt(string strText)
        {
            try
            {
                string string64 = DesDecrypt(strText, DEFAULT_ENCRYPT_KEY);
        ...
        public static string DesEncrypt(string strText, string strEncrKey)
        {
            ...
            if (bNoIV)
            {
                ...
                byte[] string64 = ms.ToArray();
                return Convert.ToBase64String(string64);
